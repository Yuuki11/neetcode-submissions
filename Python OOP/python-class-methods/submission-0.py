class Library:
    ...
    @classmethod
    def lend_books(cls, books_lent: int) -> int:
        Library.books_available -= books_lent
    @classmethod
    def return_books(cls, books_returned: int) -> int:
        Library.books_available += books_returned
